  ...
  return (
    <div className="w-50">
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="text" placeholder="Enter Product category" name="category" required />
        <Form.Text className="text-muted">
        </Form.Text>
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="text" placeholder="Enter Product Description" name="description" required />
        <Form.Text className="text-muted">
        </Form.Text>
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Product Manufacturer: </Form.Label>
        <Form.Control type="text" placeholder="Enter Product Manufacturer" name="manufacturer" required />
        <Form.Text className="text-muted">
        </Form.Text>
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Product Available Items: </Form.Label>
        <Form.Control type="text" placeholder="Enter Product Available Items" name="availableItems" required />
        <Form.Text className="text-muted">
        </Form.Text>
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
